...
//    height: 480
    ...
    color: "black"
        ...
        Timer {
            ...
            onTriggered:
            {
                console.log("qml rx,ry::",((parent.width/4.4)*3),parent.height/3)
                ec.setCoords(((parent.width/4.4)*3),parent.height/3.5);
                sp.setCoords(((parent.width/4.4)*3),((parent.height/4)*2));
                rrrrr.setCoords(((parent.width/4.4)*3),((parent.height/4.7)*3.4));
            }
        }
